...
-- This code will run once every time Awesome (re)starts
local autostart = {
    "xset r rate 160 60",
 ...
 if my.lock_delay or my.sleep_delay then
    table.insert(autostart, string.format("pkill --parent $(pgrep idle_lock); idle_lock %s %s", my.lock_delay, my.sleep_delay))
 end
